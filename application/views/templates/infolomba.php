<script src="<?= base_url('assets/js/'); ?>infolomba.js"></script>

<section id="gradient" class="info-header py-5 text-white" style="background-color: #09233E;">

  <div class="col-md-12 py-3 align-self-center" align="center">
    <img src="<?= base_url('assets/img/'); ?>mobile.png" class="img-responsive my-3" width="200" alt="">
    <h2><b>Mobile Apps Competition</b></h2>
  </div>
  ...
  <section class="container mt-5">
    <div class="row">
      ...
      <div class="col-sm-5 p-1">
        <div class="rounded border shadow p-3">
          <h5>Hadiah :</h5><br>
          <h5 class="text-center">Juara I : Rp5.000.000, Trophy, Sertifikat</h5>
          <h5 class="text-center">Juara II : Rp3.000.000, Trophy, Sertifikat</h5>
          <h5 class="text-center">Juara III : Rp2.000.000, Trophy, Sertifikat</h5>
        </div>
      </div>
    </div>
  </section>
...
<section>
  <div class="container py-5">
    <h1 class="text-center pb-5 text-secondary"><strong>Pendaftaran</strong></h1>
    <div class="col-12 p-1 text-center">
      <div class="rounded border shadow p-3">
        ...
        <ol class="text-left">
          ...
          <li><p>Mengisi formulir pendaftaran secara online pada website resmi Anforcom 2018 di <a href="<?php echo site_url()?>register" target="_blank">http://anforcom.com/register</a> mulai tanggal 29 Juli – 23 September 2018.</p></li>
...
<section>
  <div class="container py-5">
  <h1 class="text-center pb-5 text-secondary"><strong>Pelaksanaan</strong></h1>
    <div class="row">
      <div class="col-12 p-2 text-center">
        <div class="rounded border shadow p-3">
          <img class="img-fluid" src="<?= base_url('assets/img/'); ?>juri.png" alt="" style="max-height: 100px;">
          <h2 class="judul"><strong>Babak Penyisihan</strong></h2>
          <div class="row">
    ...
    <div class="row">
      <div class="col-12 p-2 text-center">
        <div class="rounded border shadow p-3">
          <img class="img-fluid" src="<?= base_url('assets/img/'); ?>pendaftaran.png" alt="" style="max-height: 100px;">
          <h2 class="judul"><strong>Sistem Penilaian</strong></h2>
          <div class="row">
            <div class="col-md-6">
              <ul class="text-left">
                <li>
              ...
              <ul class="text-left">
                <li>
                  ...
                  <ol type="a">
                    ...
                    <li><p>Jumlah viewer, like, dan comment (20%)<br>Penilaian video berdasarkan jumlah viewer, like, dan comment yang didapatkan.</p></li>
                  </ol>
                </li>
                <li>
                  <p>Kriteria Penilaian Presentasi</p>
                  <ol type="a">
                    <li><p>Pemaparan (Bobot: 30%)<br>Penilaian berdasarkan sistematika penyajian dan isi, penggunaan bahasa yang baku, cara dan sikap yang baik, serta ketepatan waktu dalam presentasi.</p></li>
                    <li><p>Gagasan dan kelayakan implementasi (40%)<br>Penilaian berdasarkan kreativitas gagasan (keunikan, manfaat, dan dampak) serta kelayakan implementasi.</p></li>
                    <li><p>Diskusi (Bobot 30%)<br>Penilaian berdasarkan tingkat pemahaman gagasan dan kontribusi anggota tim serta kemampuan menyelesaikan tantangan juri.</p></li>
                  </ol>
                </li>
              </ul>
            </div>
    ...
    <div class="row">
      <div class="col-md-6 p-2 text-center">
        <div class="rounded border shadow p-3">
          <img class="img-fluid" src="<?= base_url('assets/img/'); ?>helmwkwk.png" alt="" style="max-height: 100px;">
          <h2 class="judul"><strong>Fasilitas Peserta</strong></h2><br>
          <ol class="text-left">
            <li>Gratis satu tiket seminar Anforcom untuk tiap peserta lomba yang telah terdaftar dan terverifikasi oleh panitia Anforcom.</li>
            <li>Tanda peserta untuk tiap tim yang bertanding di babak final.</li>
            <li>Sertifikat keikutsertaan untuk tiap peserta yang bertanding di babak final.</li>
            <li>Snack dan makan siang tiap peserta finalis untuk 1 hari.</li>
            <li>Setiap tim didampingi oleh Liaison Officer (LO).</li>
          </ol>
        </div>
      </div>
      <div class="col-md-6 p-2 text-center">
        <div class="rounded border shadow p-3">
          <img class="img-fluid" src="<?= base_url('assets/img/'); ?>uploaddoc.png" alt="" style="max-height: 100px;">
          <h2 class="judul"><strong>Files</strong></h2><br>
          <small>update juklak v4 20-09-18</small><br>
          <a href="<?php echo site_url(); ?>/assets/files/Juklak Anforcom 2018 v4.pdf"><button class="btn btn-success"><i class="fa fa-download" aria-hidden="true" style="margin-right:5px;"></i> Download Petunjuk Pelaksanaan</button></a><br><br>
          <a href="<?php echo site_url(); ?>/assets/files/LAMPIRAN PROPOSAL PESERTA AV18_v1.0.docx"><button class="btn btn-success"><i class="fa fa-download" aria-hidden="true" style="margin-right:5px;"></i> Download Lampiran Proposal</button></a><br><br>
        </div>
      </div>
    </div>
  </div>
